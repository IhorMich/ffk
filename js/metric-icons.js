...
const METRIC_ICON_CLEAR = {
  ...
  duelswon: '<circle cx="5.8" cy="7.2" r="1.5"/><path d="M5.8 9v3.2l-2 3.8M5.8 12.2l2 3.8"/><circle cx="14.2" cy="7.2" r="1.5"/><path d="M14.2 9v3.2l-2 3.8M14.2 12.2l2 3.8"/><path d="M8.4 11.2h3.2"/><path d="M17.2 8.8v6.4"/><path d="M14.8 12h4.8"/>',
  support: '<circle cx="8.2" cy="7.4" r="1.6"/><path d="M8.2 9.3v3l-2.1 4M8.2 12.3l2.1 4"/><path d="M12.2 14.2c0-2.4 1.6-3.8 3.8-3.8h1.2c1.4 0 2.6 1 2.6 2.4v4.4H14.4c-1.2 0-2.2-1-2.2-2.2z"/><path d="M11.2 12.6h2.4"/>',
  ...
  losses: '<circle cx="7.4" cy="7.6" r="1.5"/><path d="M7.4 9.5v2.8l-1.8 3.6M7.4 12.3l1.8 3.6"/><circle cx="11.2" cy="13.6" r="2"/><circle cx="17.4" cy="8.4" r="1.5"/><path d="M17.4 10.2v2.6l-1.6 3.4M17.4 12.8l1.6 3.4"/><path d="M13.2 12.6 15.6 10.4"/>',
  ledtogoal: '<path d="M4.6 18.6V8h10.2v10.6"/><path d="M4.6 8h10.2"/><circle cx="9.7" cy="13.6" r="2"/><path d="M16.2 6.4 20.2 10.4M20.2 6.4 16.2 10.4"/><path d="M15.4 13.2h5.2"/><path d="M18.2 11 20.6 13.2 18.2 15.4"/>',
  badpass: '<circle cx="5.4" cy="7.6" r="1.5"/><path d="M5.4 9.5v3l-1.8 3.8M5.4 12.5l1.8 3.8"/><circle cx="16.8" cy="7.6" r="1.5"/><path d="M16.8 9.5v3l-1.8 3.8M16.8 12.5l1.8 3.8"/><path d="M7.6 11.4c2 .8 3.2 3.2 3.6 5.4"/><path d="M9.6 14.8 11.8 17.6M10.6 18.2h2.4"/>',
  badtouch: '<circle cx="6.6" cy="7.4" r="1.5"/><path d="M6.6 9.3v2.8"/><path d="M5.2 15.2c.4-1.6 1.2-2.6 2.8-2.8"/><circle cx="14.8" cy="8.6" r="2.3"/><path d="M9.4 13.6 12.6 10.2"/><path d="M13.6 10.4c1.4 1.8 2.8 4.2 2.8 6.4"/><path d="M15.2 15.2 17.6 17.8"/>',
  duelslost: '<circle cx="5.8" cy="7.2" r="1.5"/><path d="M5.8 9v3.2l-2 3.8M5.8 12.2l2 3.8"/><circle cx="14.2" cy="7.2" r="1.5"/><path d="M14.2 9v3.2l-2 3.8M14.2 12.2l2 3.8"/><path d="M8.4 11.2h3.2"/><path d="M16.4 10.2 20 13.8M20 10.2 16.4 13.8"/>',
